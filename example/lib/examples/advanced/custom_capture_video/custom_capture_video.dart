...
import 'package:agora_rtc_engine_example/examples/advanced/custom_capture_video/custom_capture_video_api.generated.dart';
...
class _CustomCaptureAudioState extends State<CustomCaptureAudio> {
  ...
  void _joinChannel() async {
    ...
    // await _api.setExternalVideoSource(
    //     true, true, true);
