...
enum CameraDirectionn { back, front }
...
class CameraDeepAr extends StatefulWidget {
  ...
  final CameraDirectionn cameraDirection;
  ...
  const CameraDeepAr(
      ...
      this.cameraDirection = CameraDirectionn.front,
...
class _CameraDeepArState extends State<CameraDeepAr> {
  ...
  Widget build(BuildContext context) {
    final Map<String, Object> args = {
      ...
      "direction": CameraDirectionn.values.indexOf(widget.cameraDirection),
      "cameraMode": CameraMode.values.indexOf(widget.cameraMode)
    };

    if (defaultTargetPlatform == TargetPlatform.android) {
      return AndroidView(
          viewType: 'deep_ar_camera',
...
class CameraDeepArController {
  ...
  static Future<CameraDeepArController> init(
    ...
    final MethodChannel channel =
        MethodChannel('deep_ar_camera/$id');
  ...
  Future switchCameraDirection({required CameraDirectionn direction}) async {
    return channel.invokeMethod('switchCameraDirection', <String, dynamic>{
      'direction': CameraDirectionn.values.indexOf(direction),
    });
  }
